...
if (!in_array($currentRouteName, $categories) && $currentRouteName != 'dashboard') {
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <p class="text-xl font-bold text-accent">StockHive</p>
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 text-sm leading-4 font-medium rounded-md text-gray-500 bg-stockhive-grey hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
