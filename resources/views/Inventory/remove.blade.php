<x-app-layout>
    ...
    <div class='bg-stockhive-grey-dark text-white overflow-hidden shadow-sm sm:rounded-lg max-w-[1200px] m-auto p-3 mt-2 py-12'>
        <form method='POST' action='{{route('inventory.removed')}}'>
                ...
                <tbody>
                    ...
                    <tr>
                            <div class='flex justify-center'>
                                        ...
                                        <td><input type='number' class="text-white bg-stockhive-grey hover:shadow-bxs hover:border-accent transition-all hover:ring-accent p-2 rounded-lg" name='ItemQtyRemove[{{$inventoryItem->IdOfItem}}]' value='{{$inventoryItem->quantity}}' min=0 max={{$inventoryItem->quantity}}></td>
